Create Procedure EMPLOYEES.LABOR_TAX_DATA_insert_update
(
...
Begin
	...
	If Not Exists (Select 1 From EMPLOYEES.LABOR_TAX_DATA Where employee_id= @poi_employee_id)
	Begin

		Insert Into EMPLOYEES.LABOR_TAX_DATA
		(
			employee_id,
			parameter_detail_id,
			state,
	...
	Begin
		...
		Update EMPLOYEES.LABOR_TAX_DATA Set
