Create Procedure EMPLOYEES.SUNAT_REMUNERATION_DATA_find_all
(
...
Begin
	...
	--EXECUTE EMPLOYEES.SUNAT_REMUNERATION_DATA_find_all '<Record> <employee_id>1</employee_id> </Record>',0,0,'',NULL;
	...
	Begin
		...
		Begin
			...
			Set @sqlJoin = '
			From EMPLOYEES.SUNAT_REMUNERATION_DATA [DB]'
		End;
		--WHERE SQL
		Begin
