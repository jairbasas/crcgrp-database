Create Procedure EMPLOYEES.INCOME_DISCOUNT_find_all
(
...
Begin
	...
	--EXECUTE EMPLOYEES.INCOME_DISCOUNT_find_all '<Record> <employee_id>1</employee_id> </Record>',0,0,'',NULL;
	...
	Begin
		...
		Begin
			...
			Set @sqlJoin = '
			From EMPLOYEES.INCOME_DISCOUNT [DB]'
		End;
		--WHERE SQL
		Begin
