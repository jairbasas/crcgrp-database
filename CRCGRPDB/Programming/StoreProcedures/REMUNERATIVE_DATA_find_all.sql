Create Procedure EMPLOYEES.REMUNERATIVE_DATA_find_all
(
...
Begin
	...
	--EXECUTE EMPLOYEES.REMUNERATIVE_DATA_find_all '<Record> <employee_id>1</employee_id> </Record>',0,0,'',NULL;
	...
	Begin
		...
		Begin
			...
			DB.salary_type_id			[salary_type_id],
			...
			Set @sqlJoin = '
			From EMPLOYEES.REMUNERATIVE_DATA [DB]'
		End;
		--WHERE SQL
		Begin
