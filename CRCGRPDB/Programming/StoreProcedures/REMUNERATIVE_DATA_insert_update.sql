Create Procedure EMPLOYEES.REMUNERATIVE_DATA_insert_update
(
      @poi_employee_id int    output,
      @piv_salary_type_id varchar(20)    ,
...
Begin
	...
	If Not Exists (Select 1 From EMPLOYEES.REMUNERATIVE_DATA Where employee_id= @poi_employee_id)
	Begin

		Insert Into EMPLOYEES.REMUNERATIVE_DATA
		(
			employee_id,
			salary_type_id,
			register_user_id,
	...
	Begin
		...
		Update EMPLOYEES.REMUNERATIVE_DATA Set
			salary_type_id = @piv_salary_type_id,
