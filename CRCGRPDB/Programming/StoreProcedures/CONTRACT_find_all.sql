Create Procedure EMPLOYEES.CONTRACT_find_all
(
...
Begin
	...
	--EXECUTE EMPLOYEES.CONTRACT_find_all '<Record> <employee_id>1</employee_id> </Record>',0,0,'',NULL;
	...
	Begin
		...
		Begin
			...
			DB.contract_type_id			[contract_type_id],
