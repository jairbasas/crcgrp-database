Create Procedure TRANSVERSAL.PARAMETER_DETAIL_search
(
...
Begin
	...
	--EXECUTE TRANSVERSAL.PARAMETER_DETAIL_search '<Record> <parameter_detail_id>1</parameter_detail_id> </Record>', '';
