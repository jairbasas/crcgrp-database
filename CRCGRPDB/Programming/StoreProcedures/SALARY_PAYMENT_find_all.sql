Create Procedure EMPLOYEES.SALARY_PAYMENT_find_all
(
...
Begin
	...
	--EXECUTE EMPLOYEES.SALARY_PAYMENT_find_all '<Record> <employee_id>1</employee_id> </Record>',0,0,'',NULL;
	...
	Begin
		...
		Begin
			...
			Set @sqlJoin = '
			From EMPLOYEES.SALARY_PAYMENT [DB]'
		End;
		--WHERE SQL
		Begin
