Create Procedure EMPLOYEES.SALARY_PAYMENT_insert_update
(
...
Begin
	...
	If Not Exists (Select 1 From EMPLOYEES.SALARY_PAYMENT Where employee_id= @poi_employee_id)
	Begin

		Insert Into EMPLOYEES.SALARY_PAYMENT
		(
			employee_id,
			account_number,
			interbank_account,
	...
	Begin
		...
		Update EMPLOYEES.SALARY_PAYMENT Set
