Create Procedure TRANSVERSAL.COMPANY_find_all
(
...
-- VARIABLES DE FILTRO
Declare @docXML int,@pii_company_id int;
...
Begin
	...
	--EXECUTE TRANSVERSAL.COMPANY_find_all '<Record> <company_id>1</company_id> </Record>',0,0,'',NULL;
