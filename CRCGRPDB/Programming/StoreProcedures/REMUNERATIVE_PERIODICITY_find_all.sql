Create Procedure EMPLOYEES.REMUNERATIVE_PERIODICITY_find_all
(
...
Begin
	...
	--EXECUTE EMPLOYEES.REMUNERATIVE_PERIODICITY_find_all '<Record> <employee_id>1</employee_id> </Record>',0,0,'',NULL;
