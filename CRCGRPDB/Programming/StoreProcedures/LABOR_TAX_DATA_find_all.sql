Create Procedure EMPLOYEES.LABOR_TAX_DATA_find_all
(
...
Begin
	...
	--EXECUTE EMPLOYEES.LABOR_TAX_DATA_find_all '<Record> <employee_id>1</employee_id> </Record>',0,0,'',NULL;
	...
	Begin
		...
		Begin
			...
			Set @sqlJoin = '
			From EMPLOYEES.LABOR_TAX_DATA [DB]'
		End;
		--WHERE SQL
		Begin
