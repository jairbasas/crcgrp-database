Create Procedure SECURITY.PARAMETER_DETAIL_find_all
(
...
Begin
	...
	--EXECUTE SECURITY.PARAMETER_DETAIL_find_all '<Record> <parameter_detail_id>1</parameter_detail_id> </Record>',0,0,'',NULL;
