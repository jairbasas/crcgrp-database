Create Procedure SECURITY.PARAMETER_DETAIL_insert_update
(
...
Begin
	...
	If Not Exists (Select 1 From SECURITY.PARAMETER_DETAIL Where parameter_detail_id= @poi_parameter_detail_id)
	Begin
	...
	Begin
		...
		Update SECURITY.PARAMETER_DETAIL Set
